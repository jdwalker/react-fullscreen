  ...
  _createClass(FullScreen, [{
    ...
    value: function enterFullScreen() {
      if (_fscreen2.default.fullscreenEnabled) {
        _fscreen2.default.requestFullscreenFunction(this.node).bind(this.node)({ navigationUI: this.props.navigationUI });
      }
    }
  }, {
    key: "leaveFullScreen",
...
FullScreen.propTypes = {
  ...
  navigationUI: _propTypes2.default.string.isRequired
};
